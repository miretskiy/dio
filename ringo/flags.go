...
const (
	...
	// TimeoutMultishot produces repeated expiry completions until canceled. It
	// requires Linux 6.4, later than the minimum New enforces, so an older
	// kernel fails the operation in its completion.
